/**
 * @file PostCard.jsx
 * @description الفايل ده هو "كارت البوست الواحد".
 * مسؤول عن عرض كل حاجة تخص البوست: الكاتب، الكلام، الصورة، والهاشتاجات.
 * وجواه كمان المنطق (Logic) بتاع عمل اللايك وكتابة الكومنتات ومسح البوست لصاحبه.
 */
